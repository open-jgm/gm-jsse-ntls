...
public class GMSSLSocketTest {
    ...
    public void getEnabledCipherSuitesTest() throws Exception {
        ...
        Assert.assertEquals("ECC-SM2-WITH-SM4-CBC-SM3", strings[0]);
        sslSocket.close();
    }
    ...
    public void setEnabledCipherSuitesTest() throws Exception {
        ...
        strings = new String[] { "ECC-SM2-WITH-SM4-CBC-SM3", "test" };
        try {
            sslSocket.setEnabledCipherSuites(strings);
            Assert.fail();
        } catch (IllegalArgumentException e) {
        ...
        strings = new String[] { "ECC-SM2-WITH-SM4-CBC-SM3", "ECC-SM2-WITH-SM4-CBC-SM3" };
        sslSocket.setEnabledCipherSuites(strings);
        ...
        Assert.assertEquals(CipherSuite.NTLS_SM2_WITH_SM4_CBC_SM3, cc.sslConfig.enabledCipherSuites.get(0));
        sslSocket.close();
    }
