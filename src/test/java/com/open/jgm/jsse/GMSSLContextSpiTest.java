...
public class GMSSLContextSpiTest {
    ...
    @Test
    public void engineCreateSSLEngineTest() throws Exception {
        ...
        Assert.assertTrue(engineCreateSSLEngine.invoke(mySSLContextSpi) instanceof GMSSLEngine);
        ...
        Object engineWithHost = engineCreateSSLEngineMethod.invoke(mySSLContextSpi, "localhost", 443);
        Assert.assertTrue(engineWithHost instanceof GMSSLEngine);
