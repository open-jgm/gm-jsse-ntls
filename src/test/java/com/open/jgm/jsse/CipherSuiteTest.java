...
public class CipherSuiteTest {
    ...
    @Test
    public void getTest() {
        String str = CipherSuite.NTLS_SM2_WITH_SM4_CBC_SM3.getName();
        Assert.assertEquals("ECC-SM2-WITH-SM4-CBC-SM3", str);

        str = CipherSuite.NTLS_SM2_WITH_SM4_CBC_SM3.getKeyExchange();
        Assert.assertEquals("SM2", str);

        str = CipherSuite.NTLS_SM2_WITH_SM4_CBC_SM3.getSignature();
    ...
    public void resolveTest() {
        ...
        Assert.assertEquals(cipherSuite, CipherSuite.NTLS_SM2_WITH_SM4_CBC_SM3);
    ...
    public void validValuesOfTest() {
        ...
        List<CipherSuite> suites = CipherSuite.validValuesOf(new String[] { "ECC-SM2-WITH-SM4-CBC-SM3" });
