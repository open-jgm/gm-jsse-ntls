...
final public class CipherSuite {
    ...
    public static final CipherSuite NTLS_SM2_WITH_SM4_CBC_SM3 = new CipherSuite("ECC", "SM2", "SM4", "SM3", 128, 0xe0, 0x13,
            "ECC-SM2-WITH-SM4-CBC-SM3", ProtocolVersion.NTLS_1_1);
    // public static final CipherSuite[] all = new CipherSuite[] {NTLS_SM2_WITH_SM4_SM3};
    public static final CipherSuite[] all = new CipherSuite[] {NTLS_SM2_WITH_SM4_CBC_SM3/*,NTLS_SM2_WITH_SM4_GCM_SM3*/};
    // public static final CipherSuite NTLS_SM2_WITH_SM4_GCM_SM3 = new CipherSuite("ECC", "SM2", "SM4", "SM3", 128, 0xe0, 0x13,
    //         "ECC-SM2-WITH-SM4-GCM-SM3", ProtocolVersion.NTLS_1_1);
    private String name;
    private byte[] id;
    ...
    public static CipherSuite resolve(int id1, int id2, ProtocolVersion version) {
        if (version == ProtocolVersion.NTLS_1_1) {
            if (id1 == 0xe0) {
                switch (id2) {
                    case 0x13:
                        return NTLS_SM2_WITH_SM4_CBC_SM3;
                    // case 0x53:
                    //     return NTLS_SM2_WITH_SM4_GCM_SM3;
                    default:
                        break;
                }
            }
    ...
    public static List<CipherSuite> validValuesOf(String[] names) {
        ...
        List<CipherSuite> cipherSuites = new ArrayList<CipherSuite>(names.length);
